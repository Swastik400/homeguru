...
export default function StatsCards() {
  return (
    <div className="bg-white rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] w-full" style={{ height: '104px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 24px', border: '1px solid #DCDCDC' }}>
