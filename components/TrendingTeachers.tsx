...
const TeacherRow = React.memo(({ teacher, index, isLast }: { teacher: typeof TEACHERS_DATA[0], index: number, isLast: boolean }) => (
  ...
  >
    ...
    <td className="py-4 pl-6 pr-4 align-middle">
      <div className="flex items-center gap-3.5">
        ...
        <div className="flex flex-col">
          <span className="text-[#111827] text-[14px] mb-[1px]">
            {teacher.name}
          </span>
          <div className="flex items-center gap-1.5 text-[#A5998B] text-[11px]">
    ...
    <td className="py-4 px-4 align-middle">
      <div className="flex items-center gap-1.5 text-[#111827] text-[14px]">
        {teacher.rating}
  ...
  return (
    <div className="w-full font-matter">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-[#1A1A1A] text-[18px] tracking-wide font-season">
          Trending Teachers
        </h2>
      </div>
        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          ...
          <thead className="sticky top-0 bg-white z-10">
            <tr className="border-b border-[#E5E7EB]">
              <th className="py-5 pl-6 pr-4 text-[11px] text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Teachers
                  <SortArrows />
                </div>
              </th>
              <th className="py-5 px-4 text-[11px] text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Rating
                  <SortArrows />
                </div>
