        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          ...
          <thead className="sticky top-0 bg-white z-10">
            <tr className="border-b border-[#E5E7EB]">
              <th className="py-5 pl-6 pr-4 text-[11.5px] font-medium text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Teachers
                  <SortArrows />
                </div>
              </th>
              <th className="py-5 px-4 text-[11.5px] font-medium text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Rating
                  <SortArrows />
                </div>
            ...
            {TEACHERS_DATA.map((teacher, index) => (
              ...
              >
                ...
                <td className="py-4 pl-6 pr-4 align-middle">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[#111827] text-[15px] font-semibold mb-[1px]">
                        {teacher.name}
                      </span>
                      <div className="flex items-center gap-1.5 text-[#A5998B] text-[11.5px] font-medium">
                ...
                <td className="py-4 px-4 align-middle">
                  <div className="flex items-center gap-1.5 text-[#111827] text-[14.5px] font-medium">
                    {teacher.rating}
                ...
                <td className="py-4 px-4 align-middle">
                  <div className="flex items-start gap-1.5">
                    ...
                    <div className="flex flex-col leading-[1.2]">
                      <span className="text-[#2D8946] text-[12px] font-semibold">
