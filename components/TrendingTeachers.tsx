  ...
  return (
    <div className="w-full font-matter">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-[#1A1A1A] text-[17px] tracking-wide font-season">
          Trending Teachers
        </h2>
      </div>
        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          ...
          <thead className="sticky top-0 bg-white z-10">
            <tr className="border-b border-[#E5E7EB]">
              <th className="py-5 pl-6 pr-4 text-[11.5px] text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Teachers
                  <SortArrows />
                </div>
              </th>
              <th className="py-5 px-4 text-[11.5px] text-[#8B92A5] uppercase tracking-wider">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-700 transition-colors">
                  Rating
                  <SortArrows />
                </div>
