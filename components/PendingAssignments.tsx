...
export default function PendingAssignments() {
  ...
  return (
    <div className="w-full bg-white rounded-[20px] border border-gray-200 p-5 font-matter shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]" style={{ height: '286px' }}>
      ...
      <div className="mt-3 bg-[#F8FAFC] rounded-[12px] px-4 py-2.5 flex items-center justify-between">
        <div className="text-[#8B92A5] text-[12px]">
          Showing <span className="text-[#111827]">1</span> of <span className="text-[#111827]">3</span>
        </div>
