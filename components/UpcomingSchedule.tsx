  ...
  return (
    <div className="w-full font-sans">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-[#1A1A1A]" style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 600, fontSize: '17px' }}>
          Upcoming Schedule
        </h2>
      </div>
        ...
        >
          ...
          <div className="relative p-4 md:p-6 flex flex-col md:flex-row md:justify-between gap-4 md:gap-6 h-full">
            ...
            <div className="flex flex-col gap-3 flex-1">
              ...
              {/* Starts In Badge */}
              <div className="bg-[#F3F4F6] text-[#6B7280] text-[13px] font-normal px-3 py-1.5 rounded-lg flex items-center gap-1.5 w-fit" style={{ fontFamily: 'DM Sans' }}>
                <Clock size={14} strokeWidth={2} />
                Starts in <span className="font-semibold text-[#1A1A1A]">{currentSchedule.startsIn}</span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center w-full md:w-[156.78px] h-auto md:h-[167.09px] md:-mt-12 py-4 md:py-0">
                ...
                <div className="flex flex-col items-center font-sans">
                  ...
                  <div className="flex items-center gap-2 text-[#334155] text-[13px] md:text-[14px] tracking-wide flex-wrap justify-center">
                    ...
                    <span className="font-bold text-[18px] leading-none mb-[4px]">·</span>
                    
                    <span className="flex items-center gap-1.5">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#475569]">
      ...
      <div className="flex items-center justify-end mt-3 w-full">
        <div className="flex items-center gap-2 text-[#6B7280] text-[13px] font-medium" style={{ fontFamily: 'DM Sans', width: '110px', height: '22px' }}>
          <button 
            onClick={handlePrev}
          ...
          <span className="flex items-center gap-1.5" style={{ fontSize: '13px' }}>
            <span className="font-semibold text-[#1A1A1A]">{currentIndex + 1}</span>
            <span>of</span>
